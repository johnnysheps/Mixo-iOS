...
@available(iOS 13.0, *)
class Discovery2VC: UIViewController {
    ...
    //Thread 1: "[<UIViewController 0x7f7abf0090b0> setValue:forUndefinedKey:]: this class is not key value coding-compliant for the key imgCBLC."
    //collect mixo
